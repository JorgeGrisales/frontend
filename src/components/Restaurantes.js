...
export const Restaurantes = (props) => {
  ...
  return (
    <div class="list-group">
      ...
      <center>
        <h1>Elija el restaurante al que desea pedir.</h1>
      </center>
      <a href="#" class="list-group-item">
        <center>
          ...
          <h1>Burguer King.</h1>
          <h5>
            Nuestras hamburguesas están hechas de 100% carne de res, sin
            conservadores, sin aditivos, sin tonterías. También hacemos nuestro
            producto estrella, la hamburguesa WHOPPER®, con 1/4 de libra* de
            deliciosa carne de res a la parrilla. Una hamburguesa grande.
          </h5>
        </center>
      </a>
